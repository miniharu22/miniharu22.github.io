...
간단한 Convolution Neural Network를 구현하여 Classification Model 성능을 측정   
...
## 1. Model Analysis for Augmentated Data    
### 1-1. Loss & Accuracy   
...
<div align="left">
  <strong>출력 결과</strong>
  <img src="/assets/images/WM/48.png" width="60%" height="60%" alt=""/>
  <p><em></em></p>
</div>
{: .notice}

- Original Data에 대해 수행할 때보다 