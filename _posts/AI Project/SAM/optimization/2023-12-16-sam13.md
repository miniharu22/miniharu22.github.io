...
<div style="display: flex; align-items: flex-start; gap: 2em; max-width: 100%;">

  <!-- 표 영역 -->
  <div style="flex: 1; min-width: 300px;">
    <strong>Accuracy (IOU) Result for FP32/FP16 models & IOU Drop rate</strong><br>
    <table>
      <thead>
        <tr>
          <th>Model</th>
  ...
  <!-- 이미지 영역 -->
  <div style="flex: 1; min-width: 300px;">
    <img src="/assets/images/sam/37.png" style="max-width: 100%; height: auto;" alt="IOU Drop Chart">
  </div>
