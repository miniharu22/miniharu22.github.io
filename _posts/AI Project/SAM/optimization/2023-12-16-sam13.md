...
<div style="text-align: left;">
  <p><strong>Benchmark(Avg FPS, Time) Result &  Drop Rate from FP32 to FP16</strong></p>
  <div style="display: flex; justify-content: center; gap: 10px;">
    <img src="/assets/images/sam/39.png" alt="" width="30%" />
    <img src="/assets/images/sam/36.png" alt="" width="60%" /> 
  </div>
</div>
{: .notice}
...
| Model Type                 | Average FPS    | Average Time (sec)     |
|----------------------------|----------------|------------------------|
| vit_b - PyTorch            | 9.96           | 0.100417               |
| vit_b - TensorRT FP32      | 15.24          | 0.065603               |
| vit_b - TensorRT FP16      | 29.32          | 0.034104               |
|----------------------------|----------------|------------------------|
| vit_l - PyTorch            | 3.91           | 0.255552               |
| vit_l - TensorRT FP32      | 4.81           | 0.208019               |
| vit_l - TensorRT FP16      | 11.09          | 0.090139               |
|----------------------------|----------------|------------------------|
| vit_h - PyTorch            | 2.22           | 0.45045               |
| vit_h - TensorRT FP32      | 2.37           | 0.421377               |
| vit_h - TensorRT FP16      | 5.97           | 0.167488               |