...
<div style="text-align: left;">
  <p><strong>Benchmark(Avg FPS, Time) Result & Performance Comparison for Framework</strong></p>
  <div style="display: flex; justify-content: center; gap: 10px;">
    <img src="/assets/images/sam/40.png" alt="" width="30%" />
    <img src="/assets/images/sam/41.png" alt="" width="60%" /> 
  </div>
</div>
{: .notice}
