...
```
<div style="border: 1px solid #ccc; padding: 1em; background-color: #f9f9f9; width: fit-content; margin: auto;">
  <strong>Accuracy (IOU) Result for FP32/FP16 models</strong>
  <br>
  <table style="margin: 1em auto; text-align: center; border-collapse: collapse;">
    <thead>
      <tr>
        <th>Model</th>
        <th>vit_b</th>
