...
<div style="border: 1px #ccc; padding: 1em; background-color: #f9f9f9;">
  <strong>Accuracy (IOU) Result for FP32/FP16 models & IOU Drop rate</strong>
  <br>
  <table>
    <thead>
      <tr>
  ...
  <br>
  <img src="/assets/images/sam/37.png" width="70%" height="70%" alt=""/>
  <p><em></em></p>
</div>
