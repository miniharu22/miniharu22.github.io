...
Pytorch 기반의 SAM model을 TensorRT 포맷으로 변환하는 코드를 구현    
...
class ExportSamH:
    ...
    def export_onnx(self):
        ...
        [first_hald_state_dict.update({key.replace("image_encoder.", ""): value}) for key, value in state_dict.items() if key in first_half]
        i = 16
