---
layout : single
title: "[MOSFET-SDevice] Vt roll-off with Tox"
categories: TCAD_Practice
excerpt: "Gate Oxide Thickness와 Vt roll-off의 상관관계 확인" 
tag: 
    - [MOSFET]
    - [TCAD]
    - [SDevice]
...
<p align="center"><img src="/assets/images/practice/19.png" width="80%" height="80%"  title="" alt=""/></p>

&nbsp;

#### 7-2. Id-Vg (Log Scale) with Tox 

&nbsp;

<p align="center"><img src="/assets/images/practice/20.png" width="80%" height="80%"  title="" alt=""/></p>

- Vt roll-off : Short-channel에 의해 소자의 문턱 전압이 감소하는 현상  
  - Tox가 증가할 수록 Cox가 증가하기 때문에 SS와 Vt 증가  
  - Short-channel에 의해 Vt roll-off 현상이 발생하더라도 Gate Oxide를 이용하여 어느 정도 완화 가능  
