...
<div align="center">
  <img src="/assets/images/AND/65.png" width="50%" height="50%" alt=""/>
  <p><em></em></p>
</div>
...
- **WFV Simulation**   
  ...
  - Fig.b는 WFV가 적용된 Metal gate를 시각화한 것으로, 전체 80x100 $$\text{nm}^2$$의 Gate area는 TiN의 입자 크기를 고려하여 동일한 면적을 가진 80개의 정사각형 unit으로 분할됨    
    - 각각의 unit은 10x10 $$\text{nm}^2$$으로 총 두 종류의 WF을 가짐   
      - **(111)**   
        - WF : 4.4eV   
        - 40%   
      - **(200)**  
