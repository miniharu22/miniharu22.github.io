...
<div style="text-align: center;">
  <div style="display: flex; justify-content: center; gap: 20px;">
    <div>
      <img src="/assets/images/AND/14.png" alt="" width="70%" height="70%" />
      <p><strong>3D simulation of the 6F2 buried wordline (bWL) cell</strong></p>
    </div>
    <div>
      <img src="/assets/images/AND/13.png" alt="" width="70%" height="70%" />
...
<div style="display: flex; justify-content: center; gap: 20px;">
  <img src="/assets/images/AND/14.png" alt="Left" style="width: 40%;" />
  <img src="/assets/images/AND/13.png" alt="Right" style="width: 40%;" />
</div>

<div style="text-align: center; margin-top: 10px;">
  <p><strong>Layout and 3D simulation of the 6F2 buried wordline (bWL) cell</strong></p>
</div>
...
<div style="text-align: center;">
  <div style="display: flex; justify-content: center; gap: 20px;">
    <div>
      <img src="/assets/images/AND/17.png" alt="" width="70%" height="70%" />
      <p><strong>3D simulation of the 6F2 buried wordline (bWL) cell</strong></p>
    </div>
    <div>
      <img src="/assets/images/AND/18.png" alt="" width="70%" height="70%" />
      <p><strong>Layout of the 6F2 buried wordline (bWL) cell</strong></p>
    </div>
  </div>
</div>
