...
<div align="center">
  <img src="/assets/images/AND/13.png" width="40%" height="40%" alt=""/>
  <p><em>Layout of the 6F2 buried wordline (bWL) cell</em></p>
</div>

<div style="text-align: left;">
  <div style="display: flex; justify-content: center; gap: 10px;">
    <img src="/assets/images/AND/14.png" alt="" width="40%" />
    <img src="/assets/images/AND/13.png" alt="" width="40%" />
  </div>
  <p><strong>(Left)Layout of the 6F2 buried wordline (bWL) cell</strong></p><br>
  <p><strong>(Right)3D simulation of the 6F2 buried wordline (bWL) cell</strong></p>
</div>
