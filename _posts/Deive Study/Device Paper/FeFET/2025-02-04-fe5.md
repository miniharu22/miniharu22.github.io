...
- **R-FeFET Process Flow**    
  ...
  - Fig.2(c)와 Fig.2(d)는 위 Process Flow로 제작된 R-FeFET의 TEM 이미지를 표시한 것으로, Etch damage가 거의 없는 $$r$$ = 75nm의 Recessed Channel이 얇은 두께의 IL/FE Gate Stack이 완전히 덮여 있음을 확인 가능함    
