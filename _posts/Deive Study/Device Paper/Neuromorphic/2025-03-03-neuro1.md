...
- **MSS의 Operation Process Flow**   
  - Fig.1(a)는 MSS의 회로도와 전체 동작에 대한 Process Flow를 도식화한 것으로 이는 다음의 과정을 밟음    
    ...
    - **$$k$$x$$N$$ 개의 CDM output current는 $$k$$개의 DL로 전달되어 각 sample 별로 독립적으로 누적되고, $$k$$ 개의 Partial Weighted Sum Current(PWSC)를 생성함**   
      ...
      - 즉, $$k$$x$$N$$ 개의 Presynaptic Node에서 $$k$$x$$M$$ 개의 Postsynaptic Neuron으로 전달되는 Signle time-step의 정보는 WL-RM의 한 cycle에서 처리됨   
...
<div align="center">
  <img src="/assets/images/Ferro/17.png" width="100%" height="100%" alt=""/>
  <p><em></em></p>
</div>
...
- **Postsynaptic 설계**
  - Postsynaptic Neuron에는 Integrate & Fire model이 HW model로 사용됨    
