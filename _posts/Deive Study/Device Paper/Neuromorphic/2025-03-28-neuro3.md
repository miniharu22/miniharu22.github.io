...
<div align='center'>
    ...
    <p>SAR-ADC Operational Latency<em></em></p>
</div>   

<div align='center'>
    $$P_{\Text{ADC}} = P_{A0} \frac{2^b}{b + 1} + P_{A1}b + P_{A2}$$<br>
    $$A_{\Text{ADC}} = A_{A0}2^b + A_{A1}b + A_{A2}$$
    <p>Power & Area Overheads<em></em></p>
</div>   

<div align='center'>
    $$b = \text{log}_2 n_M + \frac{w}{n_w}$$
    <p>Resolution<em></em></p>
</div>  
