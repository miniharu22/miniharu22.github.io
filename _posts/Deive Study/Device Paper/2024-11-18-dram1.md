...
- **Temperature Effect**   
  ...
  - 낮은 온도에서는 Trap emission rate가 감소하여 Trapped charge의 손실이 적고, 이동 가능한 carrier가 많아지지만, 동시에 Recombination rate가 증가하여 Viction SN1으로 이동하는 전자의 수가 줄어듦, 따라서 300k보다 낮은 온도에서도 $$N_{RH}$$가 증가하는 경향을 보임   
