---
layout : single
title: "[MOSFET-SDevice] $$V_T$$ roll-off with $$T_{ox}$$ Variation"
categories: 
  - Sentaurus TCAD
toc: true
toc_sticky: true
...
Gate Oxide Thickness와 $$V_T$$ roll-off의 상관관계 확인
...
- $$V_T$$ roll-off : Short-channel에 의해 소자의 문턱 전압이 감소하는 현상  
  - $$T_{ox}$$가 증가할 수록 $$C_{ox}$$가 증가하기 때문에 SS와 $$V_T$$ 증가  
  - Short-channel에 의해 $$V_T$$ roll-off 현상이 발생하더라도 Gate Oxide를 이용하여 어느 정도 완화 가능  
