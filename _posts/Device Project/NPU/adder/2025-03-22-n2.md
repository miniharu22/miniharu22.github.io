...
Convolution 연산에서 Adder Stage의 기본적인 가산기(HalfAdder, FullAdder)와 bit 압축을 위한 기본 Adder module 설계    
...
- **adder_7to3**   
  - 7개의 입력을 3개의 출력으로 압축하는 역할  
  - **데이터 처리 과정 (7-to-3 Adder)**
    - **1단계: 입력 분리**
