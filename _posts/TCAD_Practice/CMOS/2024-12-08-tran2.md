---
layout : single
title: "[SDevice] Transient Simulation with Load Capacitance"
categories: CMOS
excerpt: "Load Capacitance 값 변경에 따른 CMOS Transient curve 변화 확인"
tag: 
    - [CMOS]
    - [MOSFET]
    - [TCAD]
...
<p align="center"><img src="/assets/images/practice/41.png" width="80%" height="80%"  title="" alt=""/></p>


- Load Capacitance (CL)이 증가함에 따라, Pull-up&down의 slope가 완만해짐  
