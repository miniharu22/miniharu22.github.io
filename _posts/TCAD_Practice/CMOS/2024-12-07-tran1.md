---
layout : single
title: "[CMOS-SDevice] Transient Simulation with Inverse Area Factor"
categories: TCAD_Practice
excerpt: "Area Factor를 반전시킴으로써 Transisent curve의 변화를 확인" 
tag: 
    - [CMOS]
    - [MOSFET]
    - [TCAD]
...
<p align="center"><img src="/assets/images/practice/38.png" width="70%" height="70%"  title="" alt=""/></p>
...
<p align="center"><img src="/assets/images/practice/39.png" width="80%" height="80%"  title="" alt=""/></p>

- Drain current는 Channel Width, 즉 AreaFactor에 비례  
  - PMOS의 hole mobility는 electron보다 낮기 때문에 이를 보상하기 위해 Width를 NMOS의 수배로 설정  
  - NMOS와 PMOS의 AreaFactor를 반전시킨다면 Pull-down이 더 dominant해짐  
    - Output Voltage의 Pull-up Slope가 완만해짐  
