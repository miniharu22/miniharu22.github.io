---
layout : single
title: "[SDevice] CMOS Inverter VTC Simulation"
categories: CMOS
excerpt: "CMOS VTC 시뮬레이션" 
tag: 
    - [CMOS]
    - [MOSFET]
    - [TCAD]
...
- 동일한 Vthn일 때, Vthp가 증가함에 따라 curve가 왼쪽으로 shift  
  - 이는 Vthp가 증가하면서 PMOS가 더 낮은 전압에서 off되기 때문, 즉 스위칭 전압이 감소  
