...
$$
\[
\frac{\epsilon(x_{i+0.5})}{\epsilon_0} \left( \phi(x_{i+1}) - \phi(x_i) \right)
- \frac{\epsilon(x_{i-0.5})}{\epsilon_0} \left( \phi(x_i) - \phi(x_{i-1}) \right)
= - \frac{q N^+_{\text{dop}}(x_i)}{\epsilon_0} l_0^2
\]
$$
</div>
