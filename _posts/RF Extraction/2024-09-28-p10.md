...
<div align="center">
  ...
  <p><em>$$\text{(a) Three-dimensional schematic of NSFET used in this work}$$<br>$$\text{(b) NSFET4-channel with PTS doping}$$<br>$$\text{(c) BO NSFET4-channel}$$<br>$$\text{(d) BO NSFET3-channel}$$</em></p>
</div>
