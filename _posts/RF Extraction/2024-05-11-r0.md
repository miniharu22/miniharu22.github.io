...
<div align="center">
  $$I_c(t) = C\frac{dV_c(t)}{dt} \quad \text{(1)}$$
</div>  
...
<div align="center">
  $$ X_c = \frac{1}{2\pi f C} = \frac{1}{\omega C} \quad \text{(2)} $$
</div>  
...
<div align="center">
  $$ I_c(t) = \frac{V_c(t)}{X_c} \quad \text{(3)} $$
</div>  
...
<div align="center">
  ...
  \\
  V_c(t) = \frac{1}{C} \int I_c(t) \, dt = -\frac{1}{\omega C} I_m \cos(\omega t) = -\frac{1}{\omega C} I_m \sin\left( \omega t - \frac{\pi}{2} \right) \quad \text{(4)}
  $$
</div>  
...
<div align="center">
  $$ V_c = \frac{1}{j\omega C} I_c $$ \quad \text{(5)}
</div>  
