...
<div align="center">
  ...
  I_{in} = jwC_{gg}V_{gs}
  \\
  V_{gs} = \frac{I_{in}}{wC_{gg}} \quad \text{(1)}
  $$
</div>  
...
<div align="center">
  $$
  \frac{I_{out}}{I_{in}} = \frac{G_m}{wC_{gg}} = \frac{G_m}{2\phifC_{gg}}
  $$
</div>  
...
<div align="center">
  $$
  \frac{I_{out}}{I_{in}} = \frac{G_m}{2\phifC_{gg}} = 1 
  \\
  f = f_t = \frac{G_m}{2\phiC_{gg}}
  $$
</div>  
