...
<p align="center"><img src="/assets/images/rf/1.png" width="40%" height="40%"  title="" alt=""/></p>

- **FinFET과 NSFET의 Analog 성능 비교**   
...
- **FinFET과 NSFET의 RF 성능 비교**  
  - $$F_t$$ & $$F_{max}$$ : 각각 Current gain(|$$H_{21}$$|)와 Power gain(MUG)가 1이 되는 지점에서 Linear Extrapolation을 통해 추출   
  - NSFET의 $$F_t$$는 FinFET과 거의 동일한 성능을 보이는 반면, $$F_{max}$$는 더 낮음    

&nbsp; 

<p align="center"><img src="/assets/images/rf/2.png" width="40%" height="40%"  title="" alt=""/></p>