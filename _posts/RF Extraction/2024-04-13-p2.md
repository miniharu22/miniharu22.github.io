...
<p align="center"><img src="/assets/images/rf/9.png" width="50%" height="50%"  title="" alt=""/></p>
...
<p align="center"><img src="/assets/images/rf/10.png" width="50%" height="50%"  title="" alt=""/></p>
...
<p align="center"><img src="/assets/images/rf/11.png" width="50%" height="50%"  title="" alt=""/></p>

- **Two-port Network**
  - 2개의 독립된 Port를 가지고 있는 회로망을 의미  
  - Two-port Network의 Port는 Input Port(1 & 1')과 Output Port(2 & 2')로 구성됨  
  - Input Port의 전류/전압($$I_1$$/$$V_1$$)과 Output Pott의 전류/전압($$I_2$$/$$V_2$$)는 Two-port Network parameter로 구성된 관계식으로 표현 가능  
